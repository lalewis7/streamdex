...
class TextArray extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState){
        ...
        if (!isEqual(this.props.values, prevProps.values) || (this.props.show != prevProps.show))
            this.setState({ values: [...this.props.values] });
    }
            ...
            return <>
                <div class="col-12 mb-1">
                    <div class="input-group">
                        ...
                        <button type="button" class="btn btn-secondary d-flex align-items-center" onClick={evt => this.removeValue(index)}>
